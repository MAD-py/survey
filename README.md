...
| MaxItems(n)  | []OptionAnswer | Enforces a response that has no more selections than indicated |                                                                                 |
| MinItems(n)  | []OptionAnswer | Enforces a response that has no less selections than indicated |                                                                                 |
